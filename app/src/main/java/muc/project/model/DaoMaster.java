...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        AccessPointDao.createTable(db, ifNotExists);
        Client_AccessPointDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        AccessPointDao.dropTable(db, ifExists);
        Client_AccessPointDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(AccessPointDao.class);
        registerDaoClass(Client_AccessPointDao.class);
    }
